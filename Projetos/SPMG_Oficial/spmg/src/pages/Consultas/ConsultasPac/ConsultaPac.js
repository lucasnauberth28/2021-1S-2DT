...
class ConsultaPac extends Component{
    constructor(props){
        super(props);
        this.state = {
            listaPaciente: [],
    ...
    listaPaciente = () => 
    {
        ...
        .then(resposta => this.setState({ listaPaciente : resposta }))
        ...
        return(
            ...
            <header id='header'>
                <nav id='nav'>
                    ...
                    <ul id="menu">
                        <li><a href='http://localhost:3000/consultas/paciente'>Consultas</a></li>
                ...
                <img src={logoDark} id="logoDark"></img>
            </header>
            <main>
                <div id='textos'>
                    <h2>Paciente</h2>
